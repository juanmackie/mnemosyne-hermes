...
echo "  2. Plugin registers (python -c 'import importlib.metadata; ... mnemosyne-rust ...')"
...
echo "  5. Provider identity preserved (provider.id = mnemosyne-rust / future mnemosyne)"
