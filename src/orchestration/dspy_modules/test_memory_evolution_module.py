...
- JSON output format compatibility with Python bridge
...
def evolution_module():
    """Create MemoryEvolutionModule with Claude API (requires an active Hermes model/proxy)."""
    # Check for API key
    ...
    def test_consolidate_cluster_basic(self, evolution_module):
        ...
        memories = [
            ...
            },
            {
                ...
                "content_preview": "Tokio is the async runtime ...",
                "keywords": ["rust", "async", "tokio"],
                "memory_type": "Insight",
                "importance": 7,
                "access_count": 5
...
class TestJSONCompatibility:
    """Test JSON compatibility with Python bridge."""
